		...
		return (
			...
			>
				...
				>
					...
					<a href="https://react-cital-piano.club/" target="_blank" rel="noopener noreferrer">
					...
					<p>
						...
						help them understand music theory.
					</p>
					<h3>Features</h3>
					<ul>
						<li>Keys controlled via mouse or QWERTY keyboard </li>
						<li>Each key held down lights up pink to inform the user what keys are pressed</li>
					...
					<a href="https://oblique-strategies.ianhundere.com" target="_blank" rel="noopener noreferrer">
						<div align="center">
							<img className="image fit" src={project5} alt="Gif of Oblique Strategies" />
						</div>
					</a>
					<p>
						A very simple front-end project that displays, Oblique Strategies; a card-based method for
						inspiring artists created by Brian Eno and Peter Schmidt.
					</p>
					<p />
					<h3>Features</h3>
					<ul>
					...
					<img className="main image" src={project4} alt="Gif of Scale-O-Rama" />
					<p>
						A simple python app that allows users to find scales based on inputted notes or randomly choose
						scales from a variety of musical modes.
					</p>
					<p />
					<h3>Features</h3>
					<ul>
						<li>
							Scales randomly chosen from major, minor, dorian, phrygian, lydian, mixolydian, and locrian
							scales
						</li>
						<li>
							The itertools module is used to flatten the dictionary of scales into values which then
							allow the scales to be randomized
						</li>
						<li>
				...
				>
					...
					<p>
						...
						undergrad in Victoria, BC, Canada, where I received a Bachelor of Arts in 20th Century American
						History (from a Canadian perspective). I came back south to connect with old friends and landed
						a job at Apple Inc. in the summer of 2007, just as all Apple employees were receiving their free
					...
					<p>
						Right before I graduated, I met my wife and other half. She has kept me sane ever since. We have
						two beautiful children, whom we do our best to keep curious and motivated.
					</p>
					...
					<p>
						...
						excited to be at the forefront of creating innovative tools that add real value to people's
						lives.
					</p>
