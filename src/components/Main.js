      ...
      >
        ...
        >
          ...
          <p>
            ...
            to then record a reminder and their GPS coordinates. This reminder
            gets saved in a database to be accessible at a later time either via
            the web interface or by messaging the same number to get a list of
            reminders.{' '}
            <a
            ...
            was used to keep track of whether the user was still logged in or
            not.
          </p>
          <h3>Features</h3>
          <ul>
            ...
            <li>
              Create, retrieve, update, and delete reminders via SMS or web
              interface
            </li>
          ...
          <p>
            A front-end memory game created with JavaScript, CSS, and HTML where
            the user matches tiles based on pictures and sounds pulled randomly
            from two APIs (
            <a
          ...
          <ul>
            <li>
              Progressive level system that allows users to play 5 levels of
          ...
          <p>
            ...
            ). The user is given 2 octaves to play with as well as sheet music
            and a metronome to better help them understand music theory.
          </p>
          <h3>Features</h3>
          <ul>
            <li>Keys controlled via mouse or QWERTY keyboard </li>
            <li>
              Each key held down lights up pink to inform the user what keys are
              pressed
            </li>
          ...
          <p>
            A very simple front-end project that displays, Oblique Strategies; a
            card-based method for inspiring artists created by Brian Eno and
            Peter Schmidt.
          </p>
          <p />
          <h3>Features</h3>
          <ul>
            <li>An info modal that explains what Oblique Strategies is</li>
            <li>
          ...
          <img className="image main" src={project3} alt="Gif of Eggy Game" />
          <p>A simple shoot'em up game created using Python and Pygame.</p>
          <p />
          <h3>Features</h3>
          <ul>
            <li>
          ...
          />
          <p>
            A simple python app that allows users to find scales based on
            inputted notes or randomly choose scales from a variety of musical
            modes.
          </p>
          <p />
          <h3>Features</h3>
          <ul>
            <li>
              Scales randomly chosen from major, minor, dorian, phrygian,
              lydian, mixolydian, and locrian scales
            </li>
            <li>
              The itertools module is used to flatten the dictionary of scales
              into values which then allow the scales to be randomized
            </li>
            <li>
              If the incorrect option is chosen, the user is alerted to enter
              either "lookup" or "random"
            </li>
            <div align="right">
              <a
                href="https://github.com/ianhundere/Scales-O-Rama"
        ...
        >
          ...
          <section>
            <img className="image main" src={me} alt="ian hundere" />
          </section>
          <p>
            Born and raised in Texas, I often found myself up late at night
            tinkering about on the computer to either install the latest distro
            of Linux or meet new people on IRC. I left Texas for my undergrad in
            Victoria, BC, Canada, where I received a Bachelor of Arts in 20th
            Century American History (from a Canadian perspective). I came back
            south to connect with old friends and landed a job at Apple Inc. in
            the summer of 2007, just as all Apple employees were receiving their
            free iPhones. I worked there for a few years until I made the choice
            to go back to school to pursue a master's in education.
          </p>
          <img className="image left" src={fam} alt="my family" />
          <p>
            Right before I graduated, I met my wife and other half. She has kept
            me sane ever since. We have two beautiful children, whom we do our
            best to keep curious and motivated.
          </p>
          <img className="image right" src={code} alt="screen of code" />
          <p>
            After a gratifying run in education, both as a teacher and an
            academic tech coach (
            <a
            ...
            ), I realized how powerful technology could be in changing lives.
            Now, as a developer, I am excited to be at the forefront of creating
            innovative tools that add real value to people's lives.
          </p>
          <img className="image left" src={bike} height="150" alt="bicycle" />
          <img className="image right" src={studio} alt="music studio" />
          <p>
            When I'm not coding or with my family, I like to go on long bike
            rides or make video game sounds late into the night.
            <sub>
              <strong>ps</strong>
            </sub>
            <section align="left">
